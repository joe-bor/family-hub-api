...
public class FamilyController {
    ...
    @PostMapping("/family")
    ResponseEntity<Family> createFamily(@RequestBody @Valid Family tobeCreated) {
    ...
    ResponseEntity<Family> updateFamily(@PathVariable UUID id, @RequestBody @Valid Family family) {
